...
func (s *searchWrapper) RebuildIndex(ctx context.Context, in *resourcepb.RebuildIndexRequest,
	opts ...grpc.CallOption) (*resourcepb.RebuildIndexResponse, error) {
	return s.unifiedClient.RebuildIndex(ctx, in, opts...)
}
